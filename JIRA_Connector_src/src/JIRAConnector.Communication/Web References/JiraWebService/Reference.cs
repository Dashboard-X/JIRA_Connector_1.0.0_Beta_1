...
namespace JIRAConnector.Communication.JiraWebService {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="jirasoapservice-v2SoapBinding", Namespace="http://jira.hq.quadratica.com.ar:9091/rpc/soap/jirasoapservice-v2")]
    ...
    public partial class JiraSoapServiceService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback addAttachmentToIssueOperationCompleted;
        ...
        public JiraSoapServiceService() {
            this.Url = global::JIRAConnector.Communication.Properties.Settings.Default.JIRAConnector_Communication_JiraWebService_JiraSoapServiceService;
        ...
        /// <remarks/>
        public event addAttachmentToIssueCompletedEventHandler addAttachmentToIssueCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace="http://soap.rpc.jira.atlassian.com", ResponseNamespace="http://jira.hq.quadratica.com.ar:9091/rpc/soap/jirasoapservice-v2")]
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace="http://soap.rpc.jira.atlassian.com", ResponseNamespace="http://jira.hq.quadratica.com.ar:9091/rpc/soap/jirasoapservice-v2")]
        [return: System.Xml.Serialization.SoapElementAttribute("addAttachmentToIssueReturn")]
        public bool addAttachmentToIssue(string in0, string[] in1, RemoteIssue in2) {
            object[] results = this.Invoke("addAttachmentToIssue", new object[] {
                        in0,
                        in1,
                        in2});
            return ((bool)(results[0]));
        ...
        /// <remarks/>
        public void addAttachmentToIssueAsync(string in0, string[] in1, RemoteIssue in2) {
            this.addAttachmentToIssueAsync(in0, in1, in2, null);
        }
        
        /// <remarks/>
        public void addAttachmentToIssueAsync(string in0, string[] in1, RemoteIssue in2, object userState) {
            if ((this.addAttachmentToIssueOperationCompleted == null)) {
                this.addAttachmentToIssueOperationCompleted = new System.Threading.SendOrPostCallback(this.OnaddAttachmentToIssueOperationCompleted);
            }
            this.InvokeAsync("addAttachmentToIssue", new object[] {
                        in0,
                        in1,
                        in2}, this.addAttachmentToIssueOperationCompleted, userState);
        }
        
        private void OnaddAttachmentToIssueOperationCompleted(object arg) {
            if ((this.addAttachmentToIssueCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.addAttachmentToIssueCompleted(this, new addAttachmentToIssueCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.42")]
    public delegate void addAttachmentToIssueCompletedEventHandler(object sender, addAttachmentToIssueCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.42")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class addAttachmentToIssueCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal addAttachmentToIssueCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
